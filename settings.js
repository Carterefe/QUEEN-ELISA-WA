...
module.exports = {
  SESSION_ID: process.env.SESSION_ID || 'QUEENELISA;;;==wbfdzRFFlbyBnN4lmWzElbOJTSzUDdwAXb4Z0UxBzd1hVNohXUtY0TtglWjkVUTVkb4kkWpwd=8278725619432',
  ALIVE_REACT: '👋',
...
Qᴜᴇᴇɴ ᴇʟɪꜱᴀ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ`,
  ...
  MONGODB_URL: process.env.MONGODB_URL|| 'mongodb+srv://carterefe:<db_Dennis>@cluster0.6wwov.mongodb.net/',
  PREFIX: '.$&',
  LANGUAGE: 'EN',
